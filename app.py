...
modelst = tf.keras.models.load_model(cwd + "/20211127-02161637979419-greatXrayCTMultiClassCovid19Model.h5")
modelstxray = tf.keras.models.load_model(cwd + "/20211113-21011636837298-Covid19-XRayDetection-Model-Good-2 (1).h5")
modelstct = tf.keras.models.load_model(cwd + "/greatCTCovid19ModelGC.h5")
